        ...
        <div className="w-2/3">
            ...
            <div>
                ...
                <div className="text-mine-shaft-300 text-justify">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea vel fugit illum perferendis totam! 
                    Fugit id magni assumenda earum minus ipsam quaerat provident, vel magnam mollitia libero nemo. 
                    Recusandae rerum dolore excepturi, consequuntur accusantium ducimus error accusamus nobis at sapiente!
                </div>
            </div>
        </div>
    );
